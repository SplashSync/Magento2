...
use Splash\Local\Helpers\ImagesHelper;

/**
 * Magento 2 Products Images Fields Access
 */
trait ImagesTrait
{
    /**
    ...
    protected function getImagesFields(string $key, string $fieldName): void
    {
        ...
        $objectImagesList = $this->object->getData('media_gallery');
        //====================================================================//
    ...
    /**
     * Return Product Gallery Image Informations
     *
    ...
    private function getImageGalleryValue(string $fieldId, array $mageImage)
    {
        ...
        switch ($fieldId) {
            ...
            case 'cover':
                return ($mageImage["file"] == $this->object->getData("thumbnail"));
            case 'visible':
                return empty($mageImage["disabled"]);
            case 'image':
                return ImagesHelper::encode($mageImage["file"], $mageImage["label"]);
            default:
                return null;
        }
    }
